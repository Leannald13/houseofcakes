"""
Django settings for houseofcakes project.
...
ROOT_URLCONF = 'houseofcakes.urls'
...
WSGI_APPLICATION = 'houseofcakes.wsgi.application'
...
if 'USE_AWS' in os.environ:
    AWS_STORAGE_BUCKET_NAME = 'houseofcakes'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'houseofcakes@example.com'
else:
